    ...
    >
      <CardContent sx={{ p: 4 }}>
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={4}>
            <ReadOnlyField label="Lead Number" value={lead.leadnumber} />
          </Grid>

          <Grid item xs={12} md={4}>
            <ReadOnlyField label="Lead Status" value={lead.leadstatus} />
          </Grid>
          ...
          <Grid item xs={12} md={4}>
            <ReadOnlyField label="Priority" value={priority?.name} />
          </Grid>
          ...
          <Grid item xs={12} md={4}>
            <ReadOnlyField label="Source" value={source?.name} />
          </Grid>

          <Grid item xs={12} md={4}>
            <ReadOnlyField
              label="Expected Amount"
              value={`₹ ${Number(lead.expectedamount || 0).toLocaleString(
                "en-IN",
              )}`}
            />
          </Grid>
