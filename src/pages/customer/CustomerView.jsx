...
import Subscriptions from "../leads/subscriptions/Subscriptions";

import Payments from "../leads/payments/Payments";
import Details from "./Details";
import Call from "./tabs/call/Call";
import FollowUps from "./tabs/customerfollowup/FollowUps";
...
const CustomerView = () => {
  ...
  return (
    <>
      <PageHeader
        title={customerName}
        subtitle={`${customer?.hospitalname || "-"} • ${
          customer?.leadnumber || "-"
        }`}
        showBackButton
        backPath="/customers"
